    ...
    return '''
        ...
        <body>
            <div class="container">
                ...
                <p>Track your job applications efficiently and stay organized.</p>
                <p><a class="btn" href="/login">Login</a> or <a class="btn" href="/register">Register</a> to start tracking your job applications.</p>
            </div>
        </body>
        </html>
    '''
